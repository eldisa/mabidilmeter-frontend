(function() {
  ...
  const _PureActorManager = class _PureActorManager {
    ...
    onEffectState(event) {
      ...
      if (def.broadcastToParty) {
        ...
        if (eligible(e)) {
          e.applySyntheticDebuff(def.ccId, event.At, disableAt, event.Id);
        }
      }
    }
  ...
  class PureEntityActor extends PureBaseActor {
    ...
    applySyntheticDebuff(ccId, at, disableAt, attackerId) {
...
//# sourceMappingURL=eventWorker-DGgouZUc.js.map
